...
| **UC_TRIP_02** | Tạo lịch trình tự động bằng AI| Người dùng đăng ký| OpenAI API | AI tự động thiết kế lộ trình theo mong muốn. |
| **UC_TRIP_03** | Tối ưu hóa lộ trình ngắn nhất| Người dùng đăng ký| - | Sắp xếp các điểm dừng trong ngày theo thuật toán TSP. |
...
| **UC_TRIP_07** | Tạo hành trình tự do mới | Người dùng đăng ký| - | Thiết kế lịch trình nháp không theo khuôn mẫu bản đồ. |
| **UC_TRIP_08** | Thêm ngày vào hành trình | Người dùng đăng ký| - | Phân tách lịch trình thành các ngày cụ thể. |
| **UC_TRIP_09** | Thêm hoạt động vào ngày | Người dùng đăng ký| - | Thêm địa danh, hoạt động chi tiết vào ngày đi. |
| **UC_TRIP_10** | Cập nhật hoạt động hành trình | Người dùng đăng ký| - | Sửa đổi thông tin thời gian, chi phí, ghi chú hoạt động. |
| **UC_TRIP_11** | Xóa hoạt động hành trình | Người dùng đăng ký| - | Loại bỏ hoạt động khỏi ngày của hành trình. |
...
| **UC_SOC_03** | Tương tác bài đăng cộng đồng | Người dùng đăng ký| - | Like/Unlike, viết bình luận, lưu trữ (bookmark) bài đăng. |
...
| **UC_MAP_02** | Thay đổi bản đồ nền | Khách vãng lai | OpenStreetMap | Chuyển đổi giữa các kiểu bản đồ nền (đường phố, vệ tinh, tối, v.v.). |
...
| **UC_MAP_09** | Xem chỉ đường lộ trình | Người dùng đăng ký| OpenStreetMap | Vẽ tuyến đường đi di chuyển trên giao diện bản đồ. |
