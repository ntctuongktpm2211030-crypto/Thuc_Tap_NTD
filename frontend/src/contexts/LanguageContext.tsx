...
const translations = {
  en: {
    ...
    'planner.days':        'Days',
    'planner.budget':      'Estimated Budget ($)',
    ...
    'planner.costBreakdown': 'Cost Breakdown',
    'planner.activitiesCost': 'Activities & Meals',
    'planner.transportCost': 'Estimated Transport',
    'planner.bufferCost': 'Buffer & Snacks',
    'planner.totalDistance': 'Total Distance',
    'planner.dailyCost': 'Daily Cost',
    ...
    'planner.dayRouteGoogleMaps': 'Google Maps Route (All Day)',
    'planner.openInGoogleMaps': 'Open in Google Maps',
    'planner.directionsFromPrev': 'Directions from previous stop',
    'planner.tabList': 'List',
    'planner.tabMap': 'Map',
    'planner.selectedDay': 'Selected Day',
    'planner.regenerateDay': 'Change this day',
    'planner.regenerateSession': 'Change this session',
  ...
  vi: {
    ...
    'planner.costBreakdown': 'Bảng kê chi tiết chi phí',
    'planner.activitiesCost': 'Hoạt động & Ăn uống',
    'planner.transportCost': 'Chi phí di chuyển dự kiến',
    'planner.bufferCost': 'Dự phòng & Ăn vặt',
    'planner.totalDistance': 'Tổng quãng đường di chuyển',
    'planner.dailyCost': 'Chi phí trong ngày',
    ...
    'planner.dayRouteGoogleMaps': 'Đường đi cả ngày trên Google Maps',
    'planner.openInGoogleMaps': 'Mở Google Maps',
    'planner.directionsFromPrev': 'Chỉ đường từ điểm trước',
    'planner.tabList': 'Lịch trình',
    'planner.tabMap': 'Bản đồ',
    'planner.selectedDay': 'Ngày đang chọn',
    'planner.regenerateDay': 'Đổi ngày này',
    'planner.regenerateSession': 'Đổi buổi này',
