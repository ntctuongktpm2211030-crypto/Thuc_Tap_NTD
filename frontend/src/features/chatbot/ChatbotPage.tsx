  ...
  return (
    <div className="relative h-full bg-slate-50/80 dark:bg-slate-950 text-slate-800 dark:text-slate-100 pt-1 pb-3 px-3 sm:pt-2 sm:pb-4.5 sm:px-5 lg:pt-2 lg:pb-6 lg:px-8 font-sans overflow-hidden animate-fade-in flex flex-col">
      ...
      <div className="lg:col-span-3 surface-elevated rounded-2xl flex flex-col overflow-hidden border border-[var(--border-subtle)] relative">
        ...
        {showCitationModal && createPortal(
        ...
        {activeFeedbackMsgId && createPortal(
          <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-[999999] flex items-center justify-center p-4">
        ...
        {deleteConfirmId && createPortal(
          <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-[999999] flex items-center justify-center p-4 animate-fadeIn">
            <div className="surface-elevated rounded-2xl p-6 border border-[var(--border-subtle)] w-full max-w-sm space-y-4 shadow-2xl relative">
